...
- `list_convex_layer.py`: planned list-oriented convex layer manager for the layered stage. It will need a tangent-query routine to restore hull layers after peels.
