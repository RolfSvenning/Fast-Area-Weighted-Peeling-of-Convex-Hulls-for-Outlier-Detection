...
- `convex_layers.py`: shared full-rebuild convex-layer helpers and canonical layer ordering. This is the fixed reference for layered snapshots and visualization.
